...
Spring WS will not detect Spring beans automatically.
- By naming this bean messageDispatcherServlet, it does not replace Spring Boot’s default
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema countriesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://demo6.demo.msol.at/countriesgenerated");
